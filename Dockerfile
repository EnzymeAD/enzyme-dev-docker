...
RUN apt-get -q update \
    ...
    && apt-get install -y --no-install-recommends git ssh clang-format autoconf make ninja-build cmake gcc g++ build-essential libtool gfortran llvm-$LLVM_VERSION-dev clang-$LLVM_VERSION libomp-$LLVM_VERSION-dev libeigen3-dev libboost-dev python3 python3-pip \
